...
**Current Status:** Need to unify matrix access patterns for cubemap compatibility.
- Push constant `ViewProjectionMatrix` must be split into per-face uniform block data
- Requires modification to vertex shader synthesis system
- Work in progress for full cubemap rendering support
