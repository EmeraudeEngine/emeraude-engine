...
status: open
priority: unranked
scope: Graphics/Effects/Camera/LensFlare
opened: 2026-08-30
...
absolute brightness instead of on the source. The VeilingGlare moved to a threshold in nits set on the
...
- `src/Graphics/Effects/Camera/LensFlare.cpp` — the threshold pass.
