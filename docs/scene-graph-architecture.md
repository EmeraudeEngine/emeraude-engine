...
- **[Component Builder Pattern](component-builder-pattern.md)** - Modern API for creating and attaching components to entities
- [Graphics System](graphics-system.md) - Visual rendering details
- [Physics System](physics-system.md) - MovableTrait and physics simulation
- [Coordinate System](coordinate-system.md) - CartesianFrame representation
