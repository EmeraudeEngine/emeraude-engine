...
- RENDERING SYSTEM: Enable optional mip-mapping during render-to-textures (2D and cubemap).
...
## Post-Processing Pipeline (LensEffects)

- [ ] **Volumetric Light/Fog** — Rayons de lumière visibles dans le brouillard/particules. Atmosphère et profondeur.
- [ ] **Light Shafts (God Rays)** — Rayons lumineux directionnels à travers occluders.
...
- [ ] **Sharpen (CAS/RCAS)** — Netteté post-TAA pour compenser le flou temporel.
