...
namespace EmEn::Graphics::TextureResource
{
	 ...
	 * @version 0.8.35
	 */
	class EMEN_API Texture1D final : public Abstract
	{
		...
		public:
			 ...
			 * @version 0.8.35
			 */
			Texture1D (Resources::AbstractServiceProvider & serviceProvider, std::string name, uint32_t resourceFlags = 0) noexcept
