/*
 * src/Graphics/TextureResource/AnimatedTextureCubemap.hpp
...
{
	/**
	 * @brief The animated texture cubemap resource class.
	...
	class AnimatedTextureCubemap final : public Abstract
	{
		...
		public:
			...
			static constexpr auto ClassId{"AnimatedTextureCubemapResource"};

			/** @brief Defines the resource dependency complexity. */
			static constexpr auto Complexity{Resources::DepComplexity::One};

			/**
			 * @brief Constructs an animated texture cubemap resource.
			 ...
			 */
			AnimatedTextureCubemap (Resources::AbstractServiceProvider & serviceProvider, std::string name, uint32_t resourceFlags = 0) noexcept
			...
			{
				return Vulkan::TextureType::TextureCubeArray;
			}
			...
			/**
			 * @brief Loads from a cubemap movie resource.
...
{
	using AnimatedTextureCubemaps = Container< Graphics::TextureResource::AnimatedTextureCubemap >;
}
