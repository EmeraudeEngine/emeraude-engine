/*
 * src/Graphics/DirectPostProcessEffect.hpp
...
{
	/**
	 * @brief Abstract interface for single-pass fragment shader post-processing effects.
	 * @note These effects are compiled into a single shader program and applied in one draw call.
	...
	class DirectPostProcessEffect : public PostProcessEffect
	{
		public:
			 ...
			 */
			DirectPostProcessEffect (const DirectPostProcessEffect & copy) noexcept = default;

			/**
			 * @brief Move constructor.
			 * @param copy A reference to the copied instance.
			 */
			DirectPostProcessEffect (DirectPostProcessEffect && copy) noexcept = default;

			/**
			 * @brief Copy assignment.
			 * @param copy A reference to the copied instance.
			 * @return DirectPostProcessEffect &
			 */
			DirectPostProcessEffect & operator= (const DirectPostProcessEffect & copy) noexcept = default;
			 ...
			 * @return DirectPostProcessEffect &
			 */
			DirectPostProcessEffect & operator= (DirectPostProcessEffect && copy) noexcept = default;

			/**
			 * @brief Destructs the direct post-process effect.
			 */
			~DirectPostProcessEffect () override = default;
			 ...
			 */
			[[nodiscard]]
			virtual bool generateFragmentShaderCode (Saphir::Generator::Abstract & generator, Saphir::FragmentShader & fragmentShader) const noexcept = 0;

		protected:

			/**
			 * @brief Constructs a direct post-process effect.
			 */
