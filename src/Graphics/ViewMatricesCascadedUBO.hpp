...
namespace EmEn::Graphics
{
	...
	class EMEN_API ViewMatricesCascadedUBO final : public ViewMatricesInterface
	{
		public:
			 ...
			 * @param index The cascade index (0 to cascadeCount-1).
			 ...
			 */
			[[nodiscard]]
			const Frustum & mainFrustum () const noexcept;
			 ...
			 */
			[[nodiscard]]
			const Frustum & mainFrustum (uint32_t readStateIndex) const noexcept;
		...
		private:
			...
			static constexpr auto NearPlaneOffset{CascadeMatricesJumpOffset + 18UL};
			/** @brief Offset of the far plane distance in the buffer. */
			static constexpr auto FarPlaneOffset{CascadeMatricesJumpOffset + 19UL};
			...
			static constexpr auto EnvironmentLuminanceOffset{CascadeMatricesJumpOffset + 25UL};
			/** @brief Offset of the IBL diffuse weight in the buffer. */
			static constexpr auto IBLDiffuseWeightOffset{CascadeMatricesJumpOffset + 26UL};
			...
			struct DataState
			{
				...
				std::array< float, ViewUBOElementCount > bufferData{
					/* Cascade view-projection matrix #0. */
					1.0F, 0.0F, 0.0F, 0.0F,
					0.0F, 1.0F, 0.0F, 0.0F,
					0.0F, 0.0F, 1.0F, 0.0F,
					0.0F, 0.0F, 0.0F, 1.0F,
					/* Cascade view-projection matrix #1. */
					1.0F, 0.0F, 0.0F, 0.0F,
					0.0F, 1.0F, 0.0F, 0.0F,
					0.0F, 0.0F, 1.0F, 0.0F,
					0.0F, 0.0F, 0.0F, 1.0F,
					/* Cascade view-projection matrix #2. */
					1.0F, 0.0F, 0.0F, 0.0F,
					0.0F, 1.0F, 0.0F, 0.0F,
					0.0F, 0.0F, 1.0F, 0.0F,
					0.0F, 0.0F, 0.0F, 1.0F,
					/* Cascade view-projection matrix #3. */
					1.0F, 0.0F, 0.0F, 0.0F,
					0.0F, 1.0F, 0.0F, 0.0F,
					0.0F, 0.0F, 1.0F, 0.0F,
					0.0F, 0.0F, 0.0F, 1.0F,
					...
					0.0F, 0.0F, 0.0F, 0.0F,
					/* Cascade count, shadow bias, reserved, reserved. */
					4.0F, 0.005F, 0.0F, 0.0F,
					/* World position. */
					0.0F, 0.0F, 0.0F, 1.0F,
					/* Velocity vector. */
					0.0F, 0.0F, 0.0F, 0.0F,
					/* View properties (width, height, near, far). */
					1.0F, 1.0F, 0.1F, 1000.0F,
					/* Ambient light color. */
					0.0F, 0.0F, 0.0F, 1.0F,
