/*
 * src/Graphics/Effects/Resolve/TAA.hpp
...
namespace EmEn::Graphics::Effects::Resolve
{
	/**
	...
	class EMEN_API TAA final : public IndirectPostProcessEffect
	{
		public:
			 ...
			 * @note Closes the scene phase: it resolves the fully composited HDR image against the previous frame. */
			[[nodiscard]]
			EffectSlot
			slot () const noexcept override
			{
				return EffectSlot::TemporalAA;
			}
