/*
 * src/Graphics/Effects/Camera/ToneMapping.hpp
...
namespace EmEn::Graphics::Effects::Camera
{
	...
	class EMEN_API ToneMapping final : public IndirectPostProcessEffect
	{
		public:
			...
			/**
			 * @brief Wires a VeilingGlare effect whose glare this tone mapping applies itself.
			 ...
			 * syncCameraEffects() pairs the camera VeilingGlare and ToneMapping this way and
		...
		private:
			...
			std::shared_ptr< VeilingGlare > m_glareSource;
