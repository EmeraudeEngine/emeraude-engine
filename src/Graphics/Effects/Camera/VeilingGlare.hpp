/*
 * src/Graphics/Effects/Camera/VeilingGlare.hpp
...
{
	/**
	 * @brief HDR VeilingGlare post-processing effect using a multi-pass Dual Kawase approach.
	 ...
	 */
	class EMEN_API VeilingGlare final : public IndirectPostProcessEffect
	{
		public:

			/** @brief Class identifier. */
			static constexpr auto ClassId{"VeilingGlareEffect"};
			 ...
			 */
			struct EMEN_API VeilingGlarePushConstants
			{
				float texelSizeX;
				float texelSizeY;
				float threshold;
			...
			/**
			 * @brief Constructs a VeilingGlare effect.
			 * @param renderer A reference to the graphics renderer.
			 */
			explicit
			VeilingGlare (Renderer & renderer) noexcept
			 ...
			 */
			VeilingGlare (Renderer & renderer, const Parameters & parameters) noexcept
				: IndirectPostProcessEffect{renderer},
