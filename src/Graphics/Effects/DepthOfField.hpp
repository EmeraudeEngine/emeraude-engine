/*
 * src/Graphics/Effects/DepthOfField.hpp
...
namespace EmEn::Graphics::Effects
{
	 ...
	 */
	class DepthOfField final : public PostProcessEffect
	{
		public:
		...
		private:
			...
			/* Descriptor sets.
			 * NOTE: m_cocDescSet and m_compositeDescSet are updated every frame
			...
			std::unique_ptr< Vulkan::DescriptorSet > m_cocDescSet;
