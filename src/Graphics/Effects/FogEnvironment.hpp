/*
 * src/Scenes/Effect/FogEnvironment.hpp
...
namespace EmEn::Graphics::Effects
{
	 ...
	 */
	class FogEnvironment final : public Saphir::EffectInterface
	{
		public:
			...
			static constexpr auto ClassId{"FogEnvironment"};
			 ...
			 */
			FogEnvironment (FogMode mode = FogMode::Exponential, bool highQuality = true) noexcept;

			/** @copydoc EmEn::Saphir::EffectInterface::FogEnvironment::generateVertexShaderCode() */
			[[nodiscard]]
			...
			/** @copydoc EmEn::Saphir::EffectInterface::FogEnvironment::generateFragmentShaderCode() */
			[[nodiscard]]
