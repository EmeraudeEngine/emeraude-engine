/*
 * src/Graphics/Effects/Framebuffer/VolumetricScattering.cpp
...
/* Local inclusions. */
#include "CSMSamplingGLSL.hpp"
#include "MarchDitherGLSL.hpp"
...
static_assert(sizeof(EmEn::Graphics::Effects::Framebuffer::VolumetricScattering::ScatteringPushConstants) == 120, "ScatteringPushConstants must be exactly 120 bytes !");
