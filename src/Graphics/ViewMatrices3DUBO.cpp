...
namespace EmEn::Graphics
{
	...
	void
	ViewMatrices3DUBO::updateAmbientLightProperties (const Math::Vector< 3, float > & chromaticity, float intensity, float environmentLuminance, float IBLDiffuseWeight) noexcept
	{
