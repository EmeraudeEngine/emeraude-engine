...
namespace EmEn::Graphics::Geometry
{
	...
	class VertexResource final : public Interface
	{
		...
		public:
			 ...
			 */
			VertexResource (Resources::AbstractServiceProvider & serviceProvider, const std::string & name, uint32_t resourceFlags = 0) noexcept
		...
		private:
			 ...
			 */
			[[nodiscard]]
			bool createVideoMemoryBuffers (Vulkan::TransferManager & transferManager, const std::vector< float > & vertexAttributes, uint32_t vertexCount, uint32_t vertexElementCount) noexcept;
