...
namespace EmEn::Graphics::RenderTarget
{
	...
	class Texture final : public Abstract, public TextureResource::Abstract
	{
		public:
			...
			bool
			load (Resources::Manager & /*resourceManager*/) noexcept override
			{
			...
			bool
			load (Resources::Manager & resourceManager, const std::filesystem::path & /*filepath*/) noexcept override
			{
				return this->load(resourceManager);
			}

			/** @copydoc EmEn::Resources::ResourceTrait::load(Resources::Manager &, const Json::Value &) */
			bool
			load (Resources::Manager & resourceManager, const Json::Value & /*data*/) noexcept override
			{
				return this->load(resourceManager);
			}
