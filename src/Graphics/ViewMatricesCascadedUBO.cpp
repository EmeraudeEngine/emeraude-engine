...
namespace EmEn::Graphics
{
	...
	void
	ViewMatricesCascadedUBO::updateAmbientLightProperties (const Math::Vector< 3, float > & chromaticity, float intensity, float environmentLuminance, float IBLDiffuseWeight) noexcept
	{
