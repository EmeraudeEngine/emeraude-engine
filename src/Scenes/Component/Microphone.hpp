...
namespace EmEn::Scenes::Component
{
	...
	class Microphone final : public Abstract, public AVConsole::AbstractVirtualDevice
	{
		public:
			...
			/** @copydoc EmEn::Scenes::Component::Abstract::move(const Base::Math::CartesianFrame< float > &) noexcept */
			void
		...
		private:
			...
			void
			onOutputDeviceConnected (EngineContext & /*engineContext*/, AbstractVirtualDevice & targetDevice) noexcept override
			{
