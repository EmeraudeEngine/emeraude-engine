...
namespace EmEn::Scenes::EffectsToolkit::FX
{
	 ...
	 * (`Graphics/Effects/Shared/LightFalloffGLSL.hpp`) the radius is only a culling bound:
	 * `saturate(1 - (d/r)^4)^2` sits near 1.0 over most of the range, while `1 / d²` carries the
	 * falloff. Growing it brightens nothing, it moves the hard cut. The envelope lives in the
	 * intensity keyframes.
