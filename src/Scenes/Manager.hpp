...
namespace EmEn::Scenes
{
	...
	class Manager final : public ServiceInterface, public Libs::ObservableTrait, public Console::ControllableTrait
	{
		public:
			 ...
			 * @param groundPhysics A reference to a ground interface smart pointer. Default autogenerated.
			 * @param seaLevel A reference to a sea level interface smart pointer. Default none.
			 * @return std::shared_ptr< Scene >
			 */
			[[nodiscard]]
			std::shared_ptr< Scene > newScene (const std::string & sceneName, float boundary, const std::shared_ptr< Graphics::Renderable::AbstractBackground > & background = nullptr, const std::shared_ptr< GroundInterface > & groundPhysics = nullptr, const std::shared_ptr< SeaLevelInterface > & seaLevel = nullptr) noexcept;
