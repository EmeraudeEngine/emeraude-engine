...
namespace EmEn::Saphir
{
	...
	namespace Keys
	{
		...
		namespace GLSL
		{
			...
			/** @brief GLSL reserved keywords — present for completeness; the
			 *  language reserves these names and shader code must not use them. */
			namespace Reserved
			{
				constexpr auto Common{"common"};
				constexpr auto Partition{"partition"};
				constexpr auto Active{"active"};
				constexpr auto ASM{"asm"};
				constexpr auto Class{"class"};
				constexpr auto Union{"union"};
				constexpr auto Enum{"enum"};
				constexpr auto Typedef{"typedef"};
				constexpr auto Template{"template"};
				constexpr auto This{"this"};
				constexpr auto Resource{"resource"};
				constexpr auto Goto{"goto"};
				constexpr auto Inline{"inline"};
				constexpr auto NoInline{"noinline"};
				constexpr auto Public{"public"};
				constexpr auto Static{"static"};
				constexpr auto Extern{"extern"};
				constexpr auto External{"external"};
				constexpr auto Interface{"interface"};
				constexpr auto Long{"long"};
				constexpr auto Short{"short"};
				constexpr auto Half{"half"};
				constexpr auto Fixed{"fixed"};
				constexpr auto Unsigned{"unsigned"};
				constexpr auto Superp{"superp"};
				constexpr auto Input{"input"};
				constexpr auto Output{"output"};
				constexpr auto HalfVector2{"hvec2"};
				constexpr auto HalfVector3{"hvec3"};
				constexpr auto HalfVector4{"hvec4"};
				constexpr auto FloatVector2{"fvec2"};
				constexpr auto FloatVector3{"fvec3"};
				constexpr auto FloatVector4{"fvec4"};
				constexpr auto Filter{"filter"};
				constexpr auto SizeOf{"sizeof"};
				constexpr auto Cast{"cast"};
				constexpr auto Namespace{"namespace"};
				constexpr auto Using{"using"};
				constexpr auto Sampler3DRectangle{"sampler3DRect"};
			}
		...
		namespace Uniform
		{
			...
			constexpr auto VolumeThicknessSampler{"uVolumeThicknessSampler"};
		...
		namespace ShaderBlock::Component
		{
	...
	*/
	...
	MatrixPC (const char * componentName) noexcept
	{
		...
		output << Keys::PushConstant::Matrices << '.' << componentName;
	...
	*/
	...
	MaterialUB (const char * componentName) noexcept
	{
		...
		output << Keys::UniformBlock::Material << '.' << componentName;
	...
	LightUB (const char * componentName) noexcept
	{
		...
		output << Keys::UniformBlock::Light << '.' << componentName;
