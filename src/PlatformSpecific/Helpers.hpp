...
namespace EmEn::PlatformSpecific
{
	...
	*/
	 ...
	 */
	[[nodiscard]]
	EMEN_API int getParentProcessId (DWORD pid) noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API std::vector< COMDLG_FILTERSPEC > createExtensionFilter (const std::vector< std::pair< std::string, std::vector< std::string > > > & filters, std::map< std::wstring, std::wstring > & dataHolder);
	 ...
	 */
	[[nodiscard]]
	EMEN_API bool runFileDialogOnDedicatedThread (Window & window, bool parentToWindow, const std::function< bool (HWND ownerWindow) > & dialogBody) noexcept;
#endif
	 ...
	 */
	[[nodiscard]]
	EMEN_API bool checkProgram (const std::string & program) noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API bool hasZenity () noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API bool hasKdialog () noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API bool isKdeDesktop () noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API std::string escapeShellArg (const std::string & arg) noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API std::string cleanLoaderEnvCommand (const std::string & command) noexcept;
	 ...
	 */
	[[nodiscard]]
	EMEN_API std::string buildZenityFilters (const ExtensionFilters & filters) noexcept;
