...
namespace EmEn::Audio
{
	...
	class Manager final : public ServiceInterface, public Libs::ObservableTrait, public Console::Controllable
	{
		...
		private:
			...
			static Libs::WaveFactory::Frequency s_playbackFrequency;
			static Libs::WaveFactory::Frequency s_recordFrequency;
			static size_t s_musicChunkSize;
			/** @brief No audio device found to play sound. */
			static bool s_audioSystemAvailable;
			/** @brief No audio capture device found to record sound. */
			static bool s_audioCaptureAvailable;
