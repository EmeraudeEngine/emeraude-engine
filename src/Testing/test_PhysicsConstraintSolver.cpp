...
class MockMovableTrait : public MovableTrait
{
	...
	protected:
		...
		void
		simulatedMove (const Vector< 3, float > & worldPosition) noexcept override
		{
			m_worldPosition = worldPosition;
		}

		void
		simulatedRotation (float /*radianAngle*/, const Vector< 3, float > & /*worldDirection*/) noexcept override
		{
