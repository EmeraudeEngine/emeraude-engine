...
namespace EmEn::Resources
{
	...
	class ResourceTrait : public std::enable_shared_from_this< ResourceTrait >, public Libs::NameableTrait, public Libs::FlagTrait< uint32_t >, public Libs::ObservableTrait
	{
		public:
			 ...
			 * @return bool
			 */
			virtual bool load (Manager & resourceManager) noexcept = 0;
			 ...
			 * @return bool
			 */
			virtual bool load (Manager & resourceManager, const std::filesystem::path & filepath) noexcept;
			 ...
			 * @return bool
			 */
			virtual bool load (Manager & resourceManager, const Json::Value & data) noexcept = 0;
		...
		protected:
			 ...
			 * @note This method should be overridden if something special has to be done when loaded.
			 * @return bool
			 */
			[[nodiscard]]
			virtual
