...
namespace EmEn::Resources
{
	...
	class Manager final : public ServiceInterface
	{
		public:
			 ...
			 * @param threadCount The number of desired threads to load resource. Default automatic.
			 */
			Manager (PrimaryServices & primaryServices, NetworkManager & networkManager, size_t threadCount = std::thread::hardware_concurrency()) noexcept;
