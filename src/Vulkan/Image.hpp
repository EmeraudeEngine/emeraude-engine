...
namespace EmEn::Vulkan
{
	...
	class Image final : public AbstractDeviceDependentObject
	{
		...
		private:
			...
			/**
			 * @brief Creates the image using the Vulkan API.
			 * @return bool
			 */
			[[nodiscard]]
			...
			/**
			 * @brief Destroys the image using the Vulkan API.
			 * @return bool
			 */
			[[nodiscard]]
			...
			/**
			 * @brief Creates the image using Vulkan Memory Allocator.
			 * @return bool
			 */
			[[nodiscard]]
			...
			/**
			 * @brief Destroys the image using Vulkan Memory Allocator.
			 * @return bool
			 */
			[[nodiscard]]
