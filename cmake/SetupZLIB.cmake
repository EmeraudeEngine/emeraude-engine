...
if ( EMERAUDE_USE_SYSTEM_LIBS )
	...
	target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${ZLIB_LIBRARIES})
else ()
	message("Enabling zlib library from local source ...")

	if ( MSVC )
		if ( CMAKE_BUILD_TYPE MATCHES Debug )
			target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${LOCAL_LIB_DIR}/lib/zlibstaticd.lib) # Change to 'zsd' when new version of zlib will be released
		else ()
			target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${LOCAL_LIB_DIR}/lib/zlibstatic.lib) # Change to 'zs' when new version of zlib will be released
		endif ()
	else ()
