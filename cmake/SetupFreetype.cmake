...
if ( EMERAUDE_USE_SYSTEM_LIBS )
	...
	target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC Freetype::Freetype)
else ()
	...
	if ( CMAKE_BUILD_TYPE MATCHES Debug )
		target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC freetyped)
	else ()
		target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC freetype)
	endif ()
endif ()
