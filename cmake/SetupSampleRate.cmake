...
if ( EMERAUDE_USE_SYSTEM_LIBS )
	...
	target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${SAMPLERATE_LIBRARIES})
else ()
	message("Enabling SampleRate library from local source ...")

	if ( MSVC )
		target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${LOCAL_LIB_DIR}/lib/samplerate.lib)
	else ()
