...
if ( EMERAUDE_USE_SYSTEM_LIBS )
	...
	target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${ZSTD_LIBRARIES})
else ()
	message("Enabling ZSTD library from local source ...")

	if ( MSVC )
		target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${LOCAL_LIB_DIR}/lib/zstd_static.lib)
	else ()
		target_link_libraries(${TARGET_BINARY_FOR_SETUP} PUBLIC ${LOCAL_LIB_DIR}/lib/libzstd.a)
	endif ()
endif ()
