...
if ( UNIX AND NOT APPLE )
	...
	set(EXTERNAL_DEPENDENCIES_FILENAME linux-${LSB_RELEASE_ID_SHORT}.x86_64-${CMAKE_BUILD_TYPE}-${EXTERNAL_DEPENDENCIES_VERSION}.zip)
elseif ( APPLE )
	set(EXTERNAL_DEPENDENCIES_VERSION "010" CACHE STRING "The external dependencies version to download for macOS.")
	set(EXTERNAL_DEPENDENCIES_FILENAME mac.${CMAKE_OSX_ARCHITECTURES}-${CMAKE_BUILD_TYPE}-${EXTERNAL_DEPENDENCIES_VERSION}.zip)
elseif ( MSVC )
	...
	if ( EMERAUDE_USE_STATIC_RUNTIME )
		set(EXTERNAL_DEPENDENCIES_FILENAME windows.x86_64-${CMAKE_BUILD_TYPE}-MT-${EXTERNAL_DEPENDENCIES_VERSION}.zip)
	else ()
		set(EXTERNAL_DEPENDENCIES_FILENAME windows.x86_64-${CMAKE_BUILD_TYPE}-MD-${EXTERNAL_DEPENDENCIES_VERSION}.zip)
	endif ()
else ()
