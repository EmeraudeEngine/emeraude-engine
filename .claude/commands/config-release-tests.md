...
cmake -S . -B .claude-build-release -DCMAKE_BUILD_TYPE=Release -DEMERAUDE_ENABLE_TESTS:BOOL=ON -DCMAKE_OSX_ARCHITECTURES=arm64 -G "Ninja"

# macOS (Intel) example:
cmake -S . -B .claude-build-release -DCMAKE_BUILD_TYPE=Release -DEMERAUDE_ENABLE_TESTS:BOOL=ON -DCMAKE_OSX_ARCHITECTURES=x86_64 -G "Ninja"
